...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(code)
       tree position: line 15 of file://<WORKSPACE>/backend/src/main/scala/com/secureline/repo/channelRepo.scala
            tree tpe: <error>
              symbol: value code
   symbol definition: code: <error> (a TermSymbol)
      symbol package: com.secureline.repo
       symbol owners: value code -> method get -> object ChannelRepo
...
== Source file context for tree position ==
    ...
    15   def get(code: String_CURSOR_): Option[channel] = channels.get(code)
